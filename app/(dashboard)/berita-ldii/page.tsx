                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="pointer-events-auto px-2.5 py-1 rounded-full text-xs font-semibold bg-green-50 text-green-700 hover:bg-green-100 dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/50 transition-colors flex items-center gap-1"
                    >
                      📤 Bagikan
                    </button>
                    ...
                    <div className="mt-auto pt-1 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          className="pointer-events-auto w-5 h-5 flex items-center justify-center rounded-full text-[11px] bg-green-50 text-green-700 hover:bg-green-100 dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/50 transition-colors"
                        >
                          📤
                        </button>
