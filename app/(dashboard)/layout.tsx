...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Auto-tutup sidebar saat navigasi
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-100">
      ...
      {/* Sidebar */}
      <aside className={[
        'fixed top-0 left-0 h-full w-64 bg-blue-900 text-white flex flex-col shadow-xl z-30 transition-transform duration-300 ease-in-out',
        'lg:static lg:w-60 lg:translate-x-0 lg:shrink-0',
        ...
        {/* User Info + Tombol Keluar (ikon) */}
        <div className="px-3 py-2 border-b border-blue-800 shrink-0">
          <div className="flex items-center gap-1">
            <Link
              href="/profil"
              className="flex-1 flex items-center gap-2.5 px-2 py-2 rounded-xl hover:bg-blue-800/70 transition min-w-0"
            >
