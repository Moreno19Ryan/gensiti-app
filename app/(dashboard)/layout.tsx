...
const navItems = [
  { href: '/dashboard', label: 'Dashboard', icon: '\U0001f3e0', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/anggota', label: 'Pengguna', icon: '\U0001f465', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/kegiatan', label: 'Kegiatan', icon: '\U0001f4c5', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/keuangan', label: 'Keuangan', icon: '\U0001f4b0', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/pengumuman', label: 'Pengumuman', icon: '\U0001f4e2', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/dokumen', label: 'Dokumen', icon: '\U0001f4c1', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/notifikasi', label: 'Notifikasi', icon: '\U0001f514', roles: ['super_admin', 'daerah', 'desa', 'kelompok'] },
  { href: '/organisasi', label: 'Organisasi', icon: '\U0001f3db️', roles: ['super_admin'] },
  { href: '/audit-log', label: 'Audit Log', icon: '\U0001f4cb', roles: ['super_admin', 'daerah', 'desa', 'kelompok'], requiresKvs: true },
]
  ...
  return (
    <div className="flex min-h-screen bg-slate-100 dark:bg-slate-900 transition-colors duration-200">
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 w-full max-w-sm">
            <div className="text-center mb-4">
              <div className="text-4xl mb-2">\U0001f6aa</div>
      ...
      <aside className={[
        ...
        {/* Toggle collapse button - 3 garis putih, hanya desktop */}
        ...
        <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-4 py-3 flex items-center justify-between shrink-0 sticky top-0 z-10 transition-colors duration-200">
          ...
          <div className="flex items-center gap-1">
            ...
            <Link href="/notifikasi" className="relative p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition">
              <span className="text-xl">\U0001f514</span>
            </Link>
          </div>
        </header>
